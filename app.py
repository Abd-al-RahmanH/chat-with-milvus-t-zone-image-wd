...
milvus_port =40956 #os.getenv("MILVUS_PORT")
...
creds = {
    ...
    "apikey": "r6zSAPJm7t8GbkqJENPzmXPpOKokltDGcMREKRr5fWdh"#os.getenv("API_KEY")
}
project_id = "833c9053-ef07-455e-819f-6557dea2f8bc"#os.getenv("PROJECT_ID")
